...
.set MSRB_LOCAL_PLAYER_SOCIAL, MSRB_P4_SLIPPI_UID + 29 # u8 (1)
.set MSRB_P1_SOCIAL, MSRB_LOCAL_PLAYER_SOCIAL + 1 # u8
.set MSRB_P2_SOCIAL, MSRB_P1_SOCIAL + 1 # u8
.set MSRB_P3_SOCIAL, MSRB_P2_SOCIAL + 1 # u8
.set MSRB_P4_SOCIAL, MSRB_P3_SOCIAL + 1 # u8

# .set MSRB_ERROR_MSG, MSRB_P4_SLIPPI_UID + 29 # string (241)
.set MSRB_ERROR_MSG, MSRB_P4_SOCIAL + 1 # string (241)
